...
if __name__ == '__main__':
    ...
    #         'Head': {
    #             'name': 'MultiHead',
    #             'head_list': [{'CTCHead': {'Neck': {'name': 'svtr', 'dims': 64, 'depth': 2, 'hidden_dims': 120, 'use_guide': True}, 'Head': {'fc_decay': 1e-05}}},  {'SARHead': {'enc_dim': 512, 'max_text_length': 25}}],
    #             'out_channels_list': {'CTCLabelDecode': 97, 'SARLabelDecode': 99}
    #         }
    #     },
    #     'Loss': {
    #         'name': 'MultiLoss',
    #         'loss_config_list': [{'CTCLoss': None}, {'SARLoss': {'ignore_index': 98}}]
    #     },
    ...
    #             'transforms': [{'DecodeImage': {'img_mode': 'BGR', 'channel_first': False}}, {'MultiLabelEncode': None},
    #                            {'RecResizeImg': {'image_shape': [3, 48, 320]}},
    #                            {'KeepKeys': {'keep_keys': ['image', 'label_ctc', 'label_sar', 'length', 'valid_ratio']}}
    #                            ]},
    #         'loader': {'shuffle': False, 'drop_last': False, 'batch_size_per_card': 128, 'num_workers': 4}}, 'profiler_options': None}
