...
def paddle_train_wrapper(task_id, epochs, batch_size, learning_rate, dataset=None, node=None):
    ...
    if not os.path.exists(pretrained_model):
        pretrained_model = "moudules/paddle/pretrain_models/en_PP-OCRv3_rec_train/best_accuracy"
...
if __name__ == '__main__':
    ...
    paddle_train_wrapper(task_id, epoch, batch_size, learning_rate)
