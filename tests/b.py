...
parser.add_argument('--model', type=str, default='YOLO', choices=['YOLO'], help='Detection algorithm (default: Tesseract)')
...
def main():
    ...
    model = TrainModelType.PADDLEOCR.value
    batch_size = 32
    learning_rate = 0.01
    node = "worker1"
    dataset = "coco"
...
#         paddle_train_wrapper(epoch_num, task_id, lr, batch_size)
